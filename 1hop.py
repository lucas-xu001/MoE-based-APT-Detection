...
def train_gnn_transformer(
    ...
    for batch in train_data.seq_batches(batch_size=BATCH):
        ...
        padded_tensors1 = nn.utils.rnn.pad_sequence(src1_feature, batch_first=True).transpose(0, 1)
        padded_tensors2 = nn.utils.rnn.pad_sequence(src2_feature, batch_first=True).transpose(0, 1)
